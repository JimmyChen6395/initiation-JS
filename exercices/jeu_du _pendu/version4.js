function game() {
    ...
    //Fonction me permettant de demander au joueur de choisir le nombre de lettre du mot à trouver?
    function difficulté() {
        do {
        ...
        switch (level) {
            case "1":
                console.log('La difficulé est 5');
                newGame(5);
                break;
            case "2":
                console.log("6 diff");
    ...
    //Je démare ma partie en tirant un nombre au hasard
    difficulté();
}
